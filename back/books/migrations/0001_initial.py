# Generated by Django 4.2.20 on 2025-05-23 06:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover_img_url', models.ImageField(default='default_img.png', upload_to='books/book_covers/')),
                ('publisher', models.CharField(max_length=15)),
                ('pub_date', models.DateField()),
                ('author_name', models.CharField(max_length=15)),
                ('author_info', models.TextField()),
                ('author_profile_img_url', models.ImageField(default='default_img.png', upload_to='books/author_imgs/')),
                ('audio_file', models.FileField(blank=True, upload_to='books/audios/')),
                ('rank', models.PositiveIntegerField(blank=True, default=0, validators=[django.core.validators.MaxValueValidator(10), django.core.validators.MinValueValidator(0)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=30)),
                ('content', models.TextField()),
                ('cover_img_url', models.ImageField(default='default_img.png', upload_to='threads/thread_covers/')),
