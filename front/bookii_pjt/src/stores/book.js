  ...
  const books = ref([
    {
      ...
      isbn: '9788932901929',
      cover_img_url: 'https://image.aladin.co.kr/product/32856/95/cover500/k112938492_1.jpg',
      publisher: '문학동네',
      pub_date: '2024-03-15',
      author_name: '김영하',
    ...
    },
    {
      ...
      isbn: '9788997924905',
      cover_img_url: 'https://via.placeholder.com/150x220?text=Book+2',
      publisher: '경제출판사',
      pub_date: '2023-11-21',
      author_name: '폴 포조스키',
    ...
    },
    {
      ...
      isbn: '9788997929999',
      cover_img_url: 'https://via.placeholder.com/150x220?text=Book+3',
      publisher: '철학사',
      pub_date: '2022-09-10',
      author_name: '류시화',
    ...
    },
    {
      ...
      isbn: '9788997928888',
      cover_img_url: 'https://via.placeholder.com/150x220?text=Book+4',
      publisher: '민음사',
      pub_date: '2023-01-25',
      author_name: '정대건',
    ...
    },
    {
      ...
      isbn: '9788937473217',
      cover_img_url: 'https://via.placeholder.com/150x220?text=Book+5',
      publisher: '자음과모음',
      pub_date: '2021-09-01',
      author_name: '김초엽',
    ...
    },
    {
      ...
      isbn: '9788968331862',
      cover_img_url: 'https://via.placeholder.com/150x220?text=Book+6',
      publisher: '흔',
      pub_date: '2018-06-20',
      author_name: '백세희',
